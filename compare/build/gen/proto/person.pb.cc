    ...
    ::_pbi::ConstantInitialized) noexcept
      : _cached_size_{0},
        ...
        tags_{visibility, ::_pbi::InternalMetadataOffset::Build<
            ::Person,
            PROTOBUF_FIELD_OFFSET(::Person, _impl_.tags_)>()
        }
...
const char descriptor_table_protodef_person_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "\n\003age\030\002 \001(\005\022\014\n\004tags\030\003 \003(\tb\010editionsp\351\007"
};
...
Person::_table_ = {
  {
    ...
    // repeated string tags = 3;
    {PROTOBUF_FIELD_OFFSET(Person, _impl_.tags_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcRepeated | ::_fl::kUtf8String | ::_fl::kRepSString)},
  }},
  // no aux_entries
  {{
    "\6\4\0\4\0\0\0\0"
...
::uint8_t* PROTOBUF_NONNULL Person::_InternalSerialize(
  ...
  if (CheckHasBitForRepeated(cached_has_bits, 0x00000001U)) {
    for (int i = 0, n = this_._internal_tags_size(); i < n; ++i) {
      ...
      ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
          s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "Person.tags");
